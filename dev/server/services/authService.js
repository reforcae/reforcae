...
module.exports.validateToken = function ( model, token, expire ) {
    return Q.all([
        Q.nsend( model, 'findOne', {'pass_recover_token.token': token }),
        Q.nsend( model, 'count'  , {'pass_recover_token.token': token })
    ]);
};